...
public final class Req extends Table {
  ...
  public A6.TextEntry args(A6.TextEntry obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public A6.TextEntry.Vector argsVector(A6.TextEntry.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public A6.TextEntry headers(int j) { return headers(new A6.TextEntry(), j); }
  public A6.TextEntry headers(A6.TextEntry obj, int j) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public A6.TextEntry.Vector headersVector(A6.TextEntry.Vector obj) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public long confToken() { int o = __offset(16); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  public A6.DataEntry extraInfo(int j) { return extraInfo(new A6.DataEntry(), j); }
  public A6.DataEntry extraInfo(A6.DataEntry obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int extraInfoLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public A6.DataEntry.Vector extraInfoVector() { return extraInfoVector(new A6.DataEntry.Vector()); }
  public A6.DataEntry.Vector extraInfoVector(A6.DataEntry.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
